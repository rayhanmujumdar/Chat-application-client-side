...
export default function ChatItem({ conversation }) {
  ...
  return (
    <li>
      <Link to={`/inbox/${_id}`} className="flex items-center px-3 py-2 text-sm transition duration-150 ease-in-out border-b border-gray-300 cursor-pointer hover:bg-gray-100 focus:outline-none">
        <img
